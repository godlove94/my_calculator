...
class Calculator:
    def __init__(self, master):
        self.master = master
        master.title('Godlove\'s Calculator')

        #create screen widget
        self.screen = Text(master, state='disabled', height=5, background='yellow', fg='blue')
    ...
    def createButton(self,val,write=True,width=7):
        #this function creates a button, a takes one compulsory argument, the value that should be on the button
